...
import kr.co.landvibe.summer_coding_android.databinding.ActivityWeek2SlideshowLeesc0893Binding
import java.util.*
import kotlin.concurrent.timer

class Leesc0893SildeshowWeek2Activity : AppCompatActivity() {
    private val period: Long = 3000
    private var currentIdxTemp = 0
    private var timer: Timer? = null

    private lateinit var binding: ActivityWeek2SlideshowLeesc0893Binding
    private var mutableUriList: MutableList<Uri> = mutableListOf<Uri>()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityWeek2SlideshowLeesc0893Binding.inflate(layoutInflater)
