...
import kr.co.landvibe.summer_coding_android.leesc0893.Leesc0893Week2Activity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun init() {
        ...
        findViewById<AppCompatButton>(R.id.btnLee).setOnClickListener { startActivity<Leesc0893Week2Activity>() }
