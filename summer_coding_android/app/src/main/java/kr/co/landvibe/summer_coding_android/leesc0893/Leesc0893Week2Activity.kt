...
import kr.co.landvibe.summer_coding_android.databinding.ActivityWeek2Leesc0893Binding

class Leesc0893Week2Activity : AppCompatActivity() {

    private lateinit var binding: ActivityWeek2Leesc0893Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityWeek2Leesc0893Binding.inflate(layoutInflater)
        ...
        activityResultLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()){ result ->
            ...
            selectedImageUri?.let {
                if (imageUriList.size == 6) {
                    AlertDialog.Builder(this@Leesc0893Week2Activity)
    ...
    private fun initPlayButton() {
        binding.run {
            playButton.setOnClickListener {
                val intent = Intent(this@Leesc0893Week2Activity, Leesc0893SildeshowWeek2Activity::class.java)
                imageUriList.forEachIndexed { index, uri ->
